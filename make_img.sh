...
sudo parted /dev/loop20 mkpart fat32 1MB 316MB
...
sudo parted /dev/loop20 mkpart ext4 316MB 100%
...
sudo losetup /dev/loop20 -o 315621376 --sizelimit 3978297344 ./disk.img
